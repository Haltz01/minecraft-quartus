...
public class WireBlock extends HorizontalFacingBlock {
    ...
    public void neighborUpdate(BlockState state, World world, BlockPos pos, Block block, BlockPos neighborPos, boolean moved) {
        Withery.LOGGER.info("Update received");
        ...
        for (Direction direction : lookDirs) {
            ...
            if (aroundBlock == Withery.wireBlock || aroundBlock instanceof AbstractGateBlock || aroundBlock instanceof LeverBlock) {
        ...
        Withery.LOGGER.info("Trying to rotate to " + lookDirs.get(targetDirVal));
